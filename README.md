# Buildo База знаний — Telegram Mini App
...
Mini App интерфейс продукта База знаний. Telegram WebApp SDK, Vite SPA, Layero/Vercel deploy.

**Сценарий использования (Telegram Mini App):** Панель: загрузка файлов, история, embed-код
